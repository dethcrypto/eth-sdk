...
export interface HBTCInterface extends utils.Interface {
    ...
    functions: {
        ...
        "changeUser(address,address)": FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "changeUser", values: [string, string]): string;
    ...
    decodeFunctionResult(functionFragment: "changeUser", data: BytesLike): Result;
...
export interface HBTC extends BaseContract {
    ...
    functions: {
        ...
        changeUser(new_operator: string, new_pauser: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        changeUser(new_operator: string, new_pauser: string, overrides?: CallOverrides): Promise<void>;
        decimals(overrides?: CallOverrides): Promise<number>;
